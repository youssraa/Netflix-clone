...
import { ORIGINAL_IMG_BASE_URL , MOVIE_CATEGORIES ,TV_CATEGORIES } from '../../utils/constants/constants';
...
if (!trendingContent)
    ...
    <>
      ...
      <div className='flex flex-col text-white gap-10 bg-black py-10'>
        {contentType === "movie" }
          ...
          <div className='max-w-2xl'>
            ...
            <p className='mt-2 text-lg'>
           {
            trendingContent?.release_date?.split("-")[0] ||
             trendingContent?.first_air_date?.split("-")[0] || "Unkown"
                }{" "}
