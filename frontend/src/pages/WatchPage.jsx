...
import { ORIGINAL_IMG_BASE_URL, SMALL_IMG_BASE_URL } from '../utils/constants/constants';
...
<img src={ORIGINAL_IMG_BASE_URL+content.poster_path} alt="Paster image"
className='max-h-[600px] rounded-md'/>
</div>
{similarContent.length > 0 && (
  <div className='mt-12 maw-w-5xl mx-auto relative '>
